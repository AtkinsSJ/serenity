...
CounterStyleValue::CounterStyleValue(CounterFunction function, ValueComparingNonnullRefPtr<StyleValue const> counter_name, ValueComparingNonnullRefPtr<StyleValue const> counter_style, ValueComparingRefPtr<StyleValue const> join_string)
...
String CounterStyleValue::to_string() const
{
    ...
    list.append(m_properties.counter_name);
    if (m_properties.function == CounterFunction::Counters)
        list.append(m_properties.join_string);
