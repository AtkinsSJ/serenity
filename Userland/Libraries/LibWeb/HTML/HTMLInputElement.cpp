...
void HTMLInputElement::apply_presentational_hints(CSS::StyleProperties& style) const
{
    if (should_apply_size_attribute()) {
        auto style_value = CSS::LengthStyleValue::create({ static_cast<double>(size()), CSS::Length::Type::Ch });
...
unsigned HTMLInputElement::size() const
{
    ...
    if (auto converted = parse_non_negative_integer(size_attr); converted.has_value())
